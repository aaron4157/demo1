...
class UserServiceSpec extends Specification {
    ...
    private Long setupData() {
        ...
        def user = new User(username: 'test0', nickname: 'test_kun', password: 'testy').save(flush: true, failOnError: true)
        //new User(...).save(flush: true, failOnError: true)
        //User user = new User(...).save(flush: true, failOnError: true)
        //new User(...).save(flush: true, failOnError: true)
        //new User(...).save(flush: true, failOnError: true)
        assert user.id, "Provide a setupData() implementation for this generated test suite"
        user.id
    }
